...
def scrapear():
    ...
    scrap=open('../archivos_quizmaker/archivo.html','w')
    scrap.write(informacion)
    scrap.close()

    texto = soup.get_text()
    text_scrap=open('../archivos_quizmaker/preguntas_scrap.txt','w')
    text_scrap.write(texto)
    text_scrap.close()
    text_scrap=open('../archivos_quizmaker/preguntas_scrap.txt','r')
...
def almacenar_sociales(sociales):
    ...
    '''
    preguntas_scrap=open('../archivos_quizmaker/preguntas_scrap.txt','w')
    del sociales[0]
...
def almacenar_categorias(lista_categoria,categoria):
    ...
    preguntas_scrap=open('../archivos_quizmaker/preguntas_scrap.txt','a')
...
def extraer_pregunta(categoria):
    ...
    :return: str, str
    '''
    preguntas_scrap=open('../archivos_quizmaker/preguntas_scrap.txt','r')
